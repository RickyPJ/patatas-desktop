 ...
 */
@Embeddable
public class VentaRetencionPK implements Serializable {
    ...
    public VentaRetencionPK() {
    }

    public VentaRetencionPK(String idEmisor, String idVendedor, String idVenta, Date fecha, String idComprobante, Date fechaComprobante) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VentaRetencionPK)) {
            return false;
        }
        VentaRetencionPK other = (VentaRetencionPK) object;
    ...
    public String toString() {
        return "com.patatascrucks.entity.VentaRetencionPK[ idEmisor=" + idEmisor + ", idVendedor=" + idVendedor + ", idVenta=" + idVenta + ", fecha=" + fecha + ", idComprobante=" + idComprobante + ", fechaComprobante=" + fechaComprobante + " ]";
    }
