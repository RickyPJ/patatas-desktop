 ...
 */
@Embeddable
public class VentaNotacreditoPK implements Serializable {
    ...
    public VentaNotacreditoPK() {
    }

    public VentaNotacreditoPK(String idEmisor, String idVendedor, String idVenta, Date fecha, String idComprobante, Date fechaComprobante) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VentaNotacreditoPK)) {
            return false;
        }
        VentaNotacreditoPK other = (VentaNotacreditoPK) object;
    ...
    public String toString() {
        return "com.patatascrucks.entity.VentaNotacreditoPK[ idEmisor=" + idEmisor + ", idVendedor=" + idVendedor + ", idVenta=" + idVenta + ", fecha=" + fecha + ", idComprobante=" + idComprobante + ", fechaComprobante=" + fechaComprobante + " ]";
    }
