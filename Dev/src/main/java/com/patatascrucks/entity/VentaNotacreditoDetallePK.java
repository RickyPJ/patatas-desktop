 ...
 */
@Embeddable
public class VentaNotacreditoDetallePK implements Serializable {
    ...
    public VentaNotacreditoDetallePK() {
    }

    public VentaNotacreditoDetallePK(String idEmisor, String idVendedor, String idVenta, Date fecha, String idComprobante, Date fechaComprobante, int idProducto, int idGrupo) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VentaNotacreditoDetallePK)) {
            return false;
        }
        VentaNotacreditoDetallePK other = (VentaNotacreditoDetallePK) object;
    ...
    public String toString() {
        return "com.patatascrucks.entity.VentaNotacreditoDetallePK[ idEmisor=" + idEmisor + ", idVendedor=" + idVendedor + ", idVenta=" + idVenta + ", fecha=" + fecha + ", idComprobante=" + idComprobante + ", fechaComprobante=" + fechaComprobante + ", idProducto=" + idProducto + ", idGrupo=" + idGrupo + " ]";
    }
